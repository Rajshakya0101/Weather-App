              ...
              if(isDaytime()==true){
                ...
                switch (json.weather[0].main) {
                  ...
                  case "Snow":
                    ...
                    break;
                  case "Fog":
                    image.src = "/images/foggymoon.png";
